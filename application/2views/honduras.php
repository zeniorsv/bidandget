  ...
  <?php 
    ...
    for ($i=0; $i < count($monthsales_h) ; $i++) { 
      $object=$monthsales_h[$i];
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>Sales Of <strong><?php $date = getdate(); echo $month=$date['month']; ?>  -  Tabco Honduras</strong></h2>
